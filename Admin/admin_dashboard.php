            ...
            <div class="row">
                <div class="col-md-3 aside" >
                    <ul style="list-style-type: none;">
                        <li><h2><a class="active" href="new_bookings.php" target="demo"  >Dashboard</a></h2></li>
                        <li><h3><a href="customers.php" target="demo">Our Customers</a></h3></li>
                        <li><h3><a href="Car_Availability.php" onclick="myGallery();" target="demo">Cars Available</a></h3>
                                <ul id="dropgallery">
                                    <li><a href="Add_cars.php" target="demo">Add car</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-md-9">
                    <iframe src="iframe_default.php" name="demo" width="100%" height="800" fra frameborder="no"></iframe>
                </div>
            </div>
        </div>
