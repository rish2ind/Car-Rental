    ...
    <div class="row checkout" style="position: relative; top: -60px;">
                ...
                <center><form action="" method="post" name="payment" onsubmit="return validate();">
                   <h4 style="color: white;">Card Payment</h4>
                    <div class="form-group">                         
                        ...
                        <input type="date" name="expire" class="form-control" placeholder="mm/yyyy" style="width: 300px; padding: 18px; margin-bottom: 5px;" required="">
        ...
        <div class="col-md-4">
            <center><img src="Images/tata.jpg" alt="" class="img-responsive"></center>
                <center><h3>TATA SAFARI</h3></center>
                <center><h4>( 7 SEATER)</h4></center>
        </div>
    </div>
    <a href="#"><center><button class="btn btn-success" style="position: relative; top: -100px;">CANCLE</button></center></a>
</div>
<script>
        function validate(){
            var card = document.payment.card_number.value;
            var cvv = document.payment.CVV.value;
            var expire = document.payment.expire.value;
            if(isNaN(card)){
